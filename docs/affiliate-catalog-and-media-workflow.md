...
Status: local foundation implemented; all 60 style slots are owner-approved across 59 canonical products, and image generation is intentionally blocked on reference rights and separate scale authorization.
