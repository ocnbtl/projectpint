...
function buildTextileBodySupportPrompt(
  ...
  const physicalState = fullHeaderTextile
    ? "Show the complete camera-visible panel body, both ordinary side seams, and the complete weighted bottom hem. The unseen twelve suspension points spread the panel across most of its width, but one side carries more compression. Use quiet gravity: one broad shallow face plus one to three plainly unequal, mostly vertical compression masses. Their widths and depths vary gradually with height, and at most one trough may subtly merge or split once. Keep the primary fold direction vertical, allow only small localized cross-grain wrinkles, and finish with a modest nonperiodic weighted-hem wave."
    : "The curtain has been pulled 35-55 percent open and gathered asymmetrically to one side. Show no more than 45 percent of total panel width. Preserve one free ordinary side edge and the weighted hem. Use quiet gravity: one broad shallow face plus one to three plainly unequal, mostly vertical compression masses. Their widths and depths vary gradually with height, and at most one trough may subtly merge or split once. Keep the primary fold direction vertical, allow only small localized cross-grain wrinkles, and finish with a modest nonperiodic weighted-hem wave.";
  return [
    ...
    "Gravity and support gate: every fold and compressed mass descends from gathered suspension points above the upper frame. The gathered side is narrow only because adjacent unseen suspension points are closer together there; below that, all fabric hangs freely and quietly under gravity. Include no tieback, knot, bow, band, cord, clip, hook, hand, side attachment, contact point, singular waist, convergence toward one mid-height point, large diagonal trough, U-shaped scoop, swag, loop, folded-over mass, or theatrical drapery styling. No part of the lower body may fold upward over another, and the free weighted hem may not climb toward the mid-body.",
    "Hard rejection gate: natural verticality is correct, but adjacent folds must not become equal full-height tubes. Keep one broad fabric face visible and vary the width, depth, and highlight of the remaining one to three compressions gradually. Never create bilateral symmetry, an evenly spaced row of vertical tubes, pleats, repeated arcs, cloned grooves, or a reusable catalog silhouette. If the body can be summarized as parallel vertical stripes or as a dramatic diagonal swag, the support has failed.",
    patternInstruction,
...
function buildTextileRoomPlatePrompt(
  ...
  return [
    ...
    "Electrical safety gate: omit every outlet, receptacle, switch, wall plate, cord, charger, plug, power strip, hair tool, and electrical device from the frame unless this manifest scene explicitly requires a code-safe U.S. GFCI installation. Never generate a standard duplex receptacle or ambiguous electrical wall plate in a bathroom wet-area composition.",
    ...
    `Human trace: ${humanTraceRecipe} Add at least two other independent practical signs of use or age, chosen for this physical room rather than as decor. Leave surfaces partly occupied and spacing irregular. Place every trace outside the reserved shower insertion corridor.`,
    ...
    "Physical audit: visible plumbing, tub or shower edges, doors, storage, supports, reflections, and circulation must be complete and coherent. Electrical devices are absent unless explicitly required by this scene. Prefer matte, worn, directionally textured, and nonrepeating surfaces. No blanket gloss, tiled veins, repeated wood grain, procedural grout, impossible reflections, floating objects, or malformed fixtures.",
...
function buildStyledPrompt(
  ...
  const inputImageRoles = fullHeaderTextile
    ...
    : hiddenHeaderTextile
      ? "Input image roles: Image 1 is the reviewed one-use hidden-header room plate and the locked photographic base; its shower crop has already passed the below-suspension-line feasibility gate. Preserve its camera position, framing, architecture, plumbing, light direction, exposure, objects, wear, labels, and human irregularity. Image 2 is the reviewed one-use scene-specific body-and-hem support generated and accepted from identity evidence for this job; it alone governs side seam, thickness, color or print identity, weighted hem, one broad fabric face, one to three unequal mostly vertical compression masses, gradual width and depth variation, at most one subtle merge or split, and a quiet fresh gravity state. Natural vertical folds are correct, but never convert them into equal uninterrupted tubes. Never introduce a large diagonal trough, U-shaped scoop, swag, loop, folded-over mass, unsupported pinch, or free hem ending at or above the tub rim. Image 3 is the reviewed exact-product material/detail crop and governs only weave or print behavior, color, thickness, and surface roughness; it contains no reusable product silhouette or header. Use a provider-native edit to add only the gathered curtain body inside the empty lower shower opening, entering through the top frame already below its hidden suspension line and continuing naturally below the tub rim toward the shower interior or floor. The rod, mounts, hooks, openings, top edge, full lintel, and soffit remain outside frame. Do not redesign, restage, widen, clean, relight, or recrop the room."
  ...
  const qaFocus = [
    ...
    identityQa,
    textileRole
      ? "Textile gravity: keep one broad face plus one to three unequal mostly vertical compressions with gradual width or depth changes and at most one subtle merge or split. Reject equal full-height tubes, large diagonal troughs, U-shaped scoops, swags, loops, folded-over masses, unsupported pinches, or a free weighted hem ending at or above the tub rim."
