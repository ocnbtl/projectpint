...
function buildTextileBodySupportPrompt(
  ...
  const physicalState = fullHeaderTextile
    ? "Show the complete camera-visible panel body, both ordinary side seams, and the complete weighted bottom hem. The unseen twelve suspension points spread the panel across most of its width, but one side carries more compression. Use three to five plainly unequal primary masses: one broad shallow field, one narrow compressed pocket, and at least one bent or branching mass. At two or more different mid-body heights, a trough must visibly change direction, depth, merge, split, or terminate into diagonal or cross-grain tension instead of continuing to the hem. Change the outer silhouette width at three heights and finish with a nonperiodic weighted-hem wave."
    : "The curtain has been pulled 35-55 percent open and gathered asymmetrically to one side. Show no more than 45 percent of total panel width. Preserve one free ordinary side edge and the weighted hem. Use three to five plainly unequal primary masses: one broad shallow field, one narrow deep compressed pocket near one side, and at least one bent or branching mass. At two or more different mid-body heights, a trough must visibly change direction, depth, merge, split, or terminate into diagonal or cross-grain tension instead of continuing to the hem. Change the gathered silhouette width at three heights, add a few nonparallel secondary wrinkles, and finish with a nonperiodic weighted-hem wave.";
  return [
    ...
    "Gravity and support gate: every fold and compressed mass descends from gathered suspension points above the upper frame. The gathered side is narrow only because adjacent unseen suspension points are closer together there; below that, all fabric hangs freely under gravity. Include no tieback, knot, bow, band, cord, clip, hook, hand, side attachment, contact point, singular waist, or convergence toward one mid-height point. Mid-body direction and depth changes must remain subtle results of slack, trough merging or splitting, and fabric stiffness, never unsupported lateral force or theatrical drapery styling.",
    "Hard rejection gate: no set of similar fold channels may run uninterrupted from the upper crop to the hem. Never create bilateral symmetry, an evenly spaced row of vertical tubes, pleats, repeated arcs, cloned grooves, or a reusable catalog silhouette. If the body can be summarized as parallel vertical stripes, the support has failed.",
    patternInstruction,
