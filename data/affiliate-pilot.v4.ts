...
export const affiliatePilotV4RealismReset = {
  contractVersion: "affiliate-pilot-real-bathroom-v4.22",
...
export const affiliatePilotV4ExecutionPolicy = {
  ...
  textileReverseViewAllowsFixedBackgroundOcclusionInCurtainPlane: true,
