...
export const affiliatePilotV4RealismReset = {
  contractVersion: "affiliate-pilot-real-bathroom-v4.39",
...
export const affiliatePilotV4HumanTraceRecipes = [
  ...
  "A small damp patch darkens part of one towel, and one plain soap bar with one softened used edge rests directly on a fixed vanity counter; a dish, tray, and holder are absent; no additional movable object is present.",
