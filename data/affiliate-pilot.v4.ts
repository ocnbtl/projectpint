...
export const affiliatePilotV4RealismReset = {
  contractVersion: "affiliate-pilot-real-bathroom-v4.36",
...
export const affiliatePilotV4StyleSpecificSetExpressionOverrides = {
  ...
  "brass-terrazzo": [
    "COUNTER-ONLY TERRAZZO LANE. Terrazzo or chip aggregate is allowed only on the vanity counter or its short backsplash, with irregular sparse chips rather than a repeated confetti texture. Use champagne brass on at most one fixed hardware family. REQUIRED: floor = plain solid-color ceramic, porcelain, resilient, or wood-look finish with zero chips; wet-zone wall = plain solid-color tile or plaster with zero chips; main wall = ordinary warm-white, cream, or light neutral paint with zero chips.",
    "WET-ZONE-ONLY TERRAZZO LANE. Terrazzo or chip aggregate is allowed only on one shower, tub, or wainscot field. Use champagne brass on at most one fixed fixture family. REQUIRED: vanity counter = solid unpatterned cream, warm white, gray, or wood with zero chips; floor = plain neutral finish with zero chips; main wall = ordinary painted plaster or drywall with zero chips.",
    "FLOOR-ONLY TERRAZZO LANE. Terrazzo or chip aggregate is allowed only on one floor field, with nonrepeating chip size, spacing, and orientation. Use champagne brass on at most one small fixed hardware family. REQUIRED: vanity counter = solid unpatterned zero-chip finish; every wet-zone wall = plain solid-color tile or plaster with zero chips; main wall = ordinary warm-white, cream, or light neutral paint with zero chips.",
    "BRASS-ONLY OWNER-UPDATE LANE. Visible terrazzo, chip aggregate, confetti pattern, and speckled stone are forbidden everywhere. Express the style only through one owner-installed champagne-brass fixed hardware family plus one muted clay, ochre, tobacco, cream, or deep neutral painted joinery decision. REQUIRED: vanity counter, floor, wet-zone wall, and main wall all use ordinary zero-chip finishes, and no second warm-metal fixture family repeats the brass cue.",
    "ALTERNATE-PALETTE JOINERY LANE. Visible terrazzo, chip aggregate, and repeated brass are forbidden. Use furniture-like warm wood or muted painted joinery, pale solid counter material, quiet cream walls, and charcoal or nickel fixed hardware; one tiny brass knob or trim accent is allowed but may not repeat. REQUIRED: counter, floor, wet-zone wall, and main wall all have zero chips and no signature terrazzo pattern."
  ]
} as const;
