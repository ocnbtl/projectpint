...
export const affiliatePilotV4RealismReset = {
  contractVersion: "affiliate-pilot-real-bathroom-v4.37",
...
export const affiliatePilotV4HumanTraceRecipes = [
  ...
  "One drawer remains open by about two inches and a folded washcloth is not perfectly aligned with the counter edge.",
