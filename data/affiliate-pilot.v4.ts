...
export const affiliatePilotV4RealismReset = {
  contractVersion: "affiliate-pilot-real-bathroom-v4.29",
...
export const affiliatePilotV4StyleSpecificSetExpressionOverrides = {
  "modern-marble": [
    ...
    "FLOOR-OR-HARDWARE LANE. Express Modern Marble through one dark or muted honed stone floor, restrained hardware, or a retained period element. REQUIRED: the vanity counter and every main wet-zone wall use solid unpatterned zero-vein finishes; white-gray Carrara is forbidden in this slot.",
...
export const affiliatePilotV4StyleProfiles = {
  ...
  "modern-marble": {
    palette:
      "choose one lane from warm cream, gray, charcoal, muted green, or brown stone, with restrained black, chrome, brass, wood, or painted accents; do not default every scene to white Carrara",
    architecture:
      "use marble or marble-look on at most one major fixed surface in this scene, with properly inset basins, coherent shower glass, ordinary compatible finishes elsewhere, and sparse nonrepeating veining",
    livedIn:
