...
export const affiliatePilotV4RealismReset = {
  contractVersion: "affiliate-pilot-real-bathroom-v4.40",
...
export const affiliatePilotV4HumanTraceRecipes = [
  ...
  "Exactly one hand towel hangs fully visible from one fixed wall hook, with one small visibly darker damp patch on that towel. Exactly one plain soap bar with one softened used edge rests directly on a fixed vanity counter. A dish, tray, and holder are absent; no additional movable object is present.",
