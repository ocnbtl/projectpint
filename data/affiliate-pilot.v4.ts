...
export const affiliatePilotV4RealismReset = {
  contractVersion: "affiliate-pilot-real-bathroom-v4.8",
...
export const affiliatePilotV4ExecutionPolicy = {
  ...
  providerNativeHeaderAuditEditRequiredForFullHeader: true,
