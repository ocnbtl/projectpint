...
test("run 06 rebuilds every reference and creates an owner-curation candidate pool", () => {
  ...
  assert.ok(bambusi);
  assert.ok(bambusi.identityPrompt.includes("exactly eight INTERIOR front-to-back bamboo slat boards"));
  assert.ok(bambusi.identityPrompt.includes("exactly eight front-to-back slat boards"));
  ...
  assert.ok(bambusi.hiddenGeometryPolicy.includes("exactly eight slats with seven gaps"));
  assert.ok(bambusi.hiddenGeometryPolicy.includes("exactly eight slats and seven gaps"));
  ...
  assert.ok(bambusi.countableFeatures.includes("exactly eight lower-shelf slats"));
  assert.ok(!bambusi.countableFeatures.includes("exactly eight top gaps"));
  assert.ok(bambusi.placementInvariant.includes("eight-top-slat or eight-lower-slat identity"));
